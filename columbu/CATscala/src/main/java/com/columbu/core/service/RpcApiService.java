package com.galileo.core.service;
...
import com.galileo.protos.api.DatabaseGrpc.DatabaseImplBase;
import com.galileo.protos.api.GrpcAPI;
import com.galileo.protos.api.GrpcAPI.AccountNetMessage;
import com.galileo.protos.api.GrpcAPI.AccountPaginated;
import com.galileo.protos.api.GrpcAPI.AccountResourceMessage;
import com.galileo.protos.api.GrpcAPI.Address;
import com.galileo.protos.api.GrpcAPI.AddressPrKeyPairMessage;
import com.galileo.protos.api.GrpcAPI.AssetIssueList;
import com.galileo.protos.api.GrpcAPI.BlockExtention;
import com.galileo.protos.api.GrpcAPI.BlockLimit;
import com.galileo.protos.api.GrpcAPI.BlockList;
import com.galileo.protos.api.GrpcAPI.BlockListExtention;
import com.galileo.protos.api.GrpcAPI.BlockReference;
import com.galileo.protos.api.GrpcAPI.BytesMessage;
import com.galileo.protos.api.GrpcAPI.EasyTransferByPrivateMessage;
...
import com.galileo.protos.api.GrpcAPI.Node;
...
import com.galileo.protos.api.GrpcAPI.ProposalList;
import com.galileo.protos.api.GrpcAPI.Return;
import com.galileo.protos.api.GrpcAPI.Return.response_code;
import com.galileo.protos.api.GrpcAPI.TransactionExtention;
import com.galileo.protos.api.GrpcAPI.TransactionList;
import com.galileo.protos.api.GrpcAPI.TransactionListExtention;
import com.galileo.protos.api.GrpcAPI.WitnessList;
import com.galileo.protos.api.WalletExtensionGrpc;
import com.galileo.protos.api.WalletGrpc.WalletImplBase;
import com.galileo.protos.api.WalletSolidityGrpc.WalletSolidityImplBase;
import com.galileo.core.appManage.Service;
import com.galileo.encrypt.ECKey;
import com.galileo.core.overlay.discover.node.NodeHandler;
import com.galileo.core.overlay.discover.node.NodeManager;
...
import com.galileo.protos.protos.Contract.AssetIssueContract;
...
import com.galileo.protos.protos.Protocol.Exchange;
import com.galileo.protos.protos.Protocol.Proposal;
...
import com.galileo.protos.protos.Protocol.TransactionSign;
...
//    }
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            com.galileo.core.overlay.discover.node.Node node = v.getValue().getNode();
